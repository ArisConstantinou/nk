...
const unifiedStoryImages: Record<HeaderCampaignId, readonly {src: string; alt: string}[]> = {
  ...
  '05': [
    {src: 'assets/heroes/smart-home-automation.webp', alt: 'Automated shading and lighting controls'},
    {src: 'assets/generated/cyprus-lighting-hero.webp', alt: 'Daylight-balanced interior lighting'},
    {src: 'assets/generated/material-light.webp', alt: 'Controlled natural light in an interior'},
  ],
  '06': [
