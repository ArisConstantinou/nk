...
export const team: TeamMember[] = [
  ...
  {name: 'Aris Constantinou', role: 'Electricians Manager', responsibility: 'Site delivery', workArea: 'Site delivery & electricians coordination', characteristics: ['Crew planning', 'On-site quality', 'Safety checks'], image: publicAsset('assets/team/illustrated/aris-faceless.webp'), linkedin: 'https://www.linkedin.com/in/aris-constantinou-94624986/', branch: 'Delivery'},
  ...
  {name: 'Installation team', role: 'Electrical Installation Team', responsibility: 'Field execution', workArea: 'Residential & commercial sites', characteristics: ['Containment & wiring', 'Fitting installation', 'Maintenance'], credential: 'Qualified field delivery', image: publicAsset('assets/team/illustrated/electricians-faceless.webp'), branch: 'Delivery'},
  {name: 'Andreas Constantinou', role: 'Electrical Engineer', responsibility: 'Automation & controls', workArea: 'Automation & control engineering', characteristics: ['System logic', 'Control panels', 'Commissioning'], credential: 'MSc Advanced Control & Systems Engineering', email: 'andreas@nk-electrical.com', image: publicAsset('assets/team/illustrated/andreas-faceless.webp'), linkedin: 'https://www.linkedin.com/in/andreas-constantinou-66707278/', branch: 'Engineering'},
  {name: 'Andreas M.', role: 'Home Systems Specialist', responsibility: 'Smart systems', workArea: 'Smart home, security, sound & vision', characteristics: ['KNX control', 'Remote access', 'System integration'], credential: 'Connected-home systems specialist', image: publicAsset('assets/team/illustrated/andreas-m-faceless.webp'), branch: 'Engineering'},
  {name: 'Lenia Kouri', role: 'Sales', responsibility: 'Showroom & sales', workArea: 'Showroom guidance & product sales', characteristics: ['Product matching', 'Customer support', 'Order coordination'], email: 'info@nk-electrical.com', image: publicAsset('assets/team/illustrated/lenia-faceless.webp'), branch: 'Design & retail'},
];
