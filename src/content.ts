...
export const team: TeamMember[] = [
  {name: 'Ntinos Constantinou', role: 'Founder · Director', workArea: 'Company direction & technical oversight', characteristics: ['Project judgement', 'Client accountability', 'Four decades of experience'], email: 'ntinos@nk-electrical.com', image: publicAsset('assets/team/illustrated/ntinos-faceless.webp'), linkedin: 'https://www.linkedin.com/in/ntinos-constantinou-21b939b4/', branch: 'Leadership'},
  {name: 'Eliana Constantinou', role: 'Founder · Accountant', workArea: 'Finance, administration & supplier coordination', characteristics: ['Budget control', 'Accounts', 'Operational continuity'], email: 'eliana@nk-electrical.com', image: publicAsset('assets/team/illustrated/eliana-faceless.webp'), branch: 'Leadership'},
  {name: 'Andreas Constantinou', role: 'Electrical Engineer', workArea: 'Automation & control engineering', characteristics: ['System logic', 'Control panels', 'Commissioning'], credential: 'MSc Advanced Control & Systems Engineering', email: 'andreas@nk-electrical.com', image: publicAsset('assets/team/illustrated/andreas-faceless.webp'), linkedin: 'https://www.linkedin.com/in/andreas-constantinou-66707278/', branch: 'Engineering'},
  {name: 'Stephanos Constantinou', role: 'Electrical Engineer', workArea: 'Power distribution & electrical engineering', characteristics: ['Load studies', 'Protection design', 'Testing'], credential: 'MSc Electrical Power Engineering', email: 'stephanos@nk-electrical.com', image: publicAsset('assets/team/illustrated/stephanos-faceless.webp'), linkedin: 'https://www.linkedin.com/in/stephanos-constantinou-39343514b/', branch: 'Engineering'},
  {name: 'Thelma Constantinou', role: 'Lighting Department', workArea: 'Interior & architectural lighting', characteristics: ['Lighting plans', 'Luminaire specification', 'Atmosphere & glare control'], credential: 'MA Interior Design · BA Interior Architecture', email: 'thelma@nk-electrical.com', image: publicAsset('assets/team/illustrated/thelma-faceless.webp'), linkedin: 'https://www.linkedin.com/in/thelma-constantinou-164aa097/', branch: 'Design & retail'},
  {name: 'Lenia Kouri', role: 'Sales', workArea: 'Showroom guidance & product sales', characteristics: ['Product matching', 'Customer support', 'Order coordination'], email: 'info@nk-electrical.com', image: publicAsset('assets/team/illustrated/lenia-faceless.webp'), branch: 'Design & retail'},
  {name: 'Andreas M.', role: 'Home Systems Specialist', workArea: 'Smart home, security, sound & vision', characteristics: ['KNX control', 'Remote access', 'System integration'], credential: 'Connected-home systems specialist', image: publicAsset('assets/team/illustrated/andreas-m-faceless.webp'), branch: 'Engineering'},
  {name: 'Aris Constantinou', role: 'Electricians Manager', workArea: 'Site delivery & electricians coordination', characteristics: ['Crew planning', 'On-site quality', 'Safety checks'], image: publicAsset('assets/team/illustrated/aris-faceless.webp'), linkedin: 'https://www.linkedin.com/in/aris-constantinou-94624986/', branch: 'Delivery'},
  {name: 'Installation team', role: 'Electrical Installation Team', workArea: 'Residential & commercial sites', characteristics: ['Containment & wiring', 'Fitting installation', 'Maintenance'], credential: 'Qualified field delivery', image: publicAsset('assets/team/illustrated/electricians-faceless.webp'), branch: 'Delivery'},
];
