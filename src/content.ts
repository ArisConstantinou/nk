...
export const products: Product[] = [
  ...
  product('el-led', 'EL LED ceiling light', 'Lighting', 'All year', 'Bedroom', 'webp', 'Quiet, even illumination for restful interiors.'),
  ...
  product('nespresso', 'Nespresso Lattissima Touch', 'Coffee', 'Christmas', 'Kitchen', 'webp', 'Milk-based coffee at the touch of a button.'),
  product('delonghi', 'De’Longhi coffee maker', 'Coffee', 'All year', 'Kitchen', 'png', 'A familiar, focused coffee station for the home.'),
  product('blaupunkt', 'Blaupunkt coffee maker', 'Coffee', 'All year', 'Kitchen', 'webp', 'Straightforward preparation in a compact footprint.'),
  ...
  product('bosch-multitalent', 'Bosch MultiTalent 3', 'Kitchen', 'All year', 'Kitchen', 'webp', 'Versatile processing with space-conscious storage.'),
...
export const defaultContent: SiteContent = {
  ...
  themeContent: {
    tech: {
      ...
      sectionTitle: 'Five services. One accountable team.',
      sectionBody: 'We plan, install and support electrical, lighting, automation, security and maintenance systems.',
    },
  },
  products,
  catalogues,
