...
export function AdminLayout() {
  ...
  return <div className="nk-admin-shell">
    ...
    <nav className="nk-admin-mobile-nav" aria-label={text('Mobile admin navigation', 'Κύρια πλοήγηση διαχείρισης')}>
      ...
      <Link to="/?liveEdit=1" onClick={() => {closeCommand('dismiss'); setMobileOpen(false); setExplorerOpen(false); setQuickAddOpen(false);}}><ExternalLink/><span>{text('Website', 'Ιστοσελίδα')}</span></Link>
    </nav>
