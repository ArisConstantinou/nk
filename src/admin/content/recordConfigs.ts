...
export const recordConfigs: Record<ContentKind, RecordConfig> = {
  ...
  settings: {kind: 'settings', eyebrow: 'SITE / GLOBAL LAYOUT', title: 'Header, footer & settings', description: 'Maintain the global brand, calls to action, contact details and footer copy.', singular: 'settings record', singleton: true, defaults: {address: '', phone: '', email: '', hours: '', mapsUrl: '', enquiryRecipient: '', brandName: 'NK Electrical', brandTagline: 'Power · Light · Control', quoteLabel: 'Request a Quote', quoteUrl: '/request-a-quote', footerEyebrow: 'PROJECT LINE / CYPRUS', footerTitle: 'Define the requirement. Then build it properly.', footerCtaLabel: 'Request a Quote', footerCopyright: 'NK Electrical Ltd. · Since 1985'}, fields: [
